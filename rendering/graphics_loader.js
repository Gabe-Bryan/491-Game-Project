class GraphicsLoader {
    constructor() {
        ...
        GRAPHICS.addAnimation('ANIMA_link_attack_west', 'SET_link_attack_west', 6, [0.095, 0.06, 0.04, 0.03, 0.06, 0.095]).addDamageSprites(); 
        ...
        GRAPHICS.addAnimation('ANIMA_link_attack_north', 'SET_link_attack_north',
            [0,1,2,3,4], [0.10, 0.07, 0.04, 0.07, 0.10]).addDamageSprites();
        ...
        GRAPHICS.addAnimation('ANIMA_link_attack_south', 'SET_link_attack_south',
            6, [0.095, 0.06, 0.04, 0.03, 0.06, 0.095], -3, 3).addDamageSprites();
